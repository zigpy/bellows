...
EZSP_SCHEMA = vol.Schema(
    {
        ...
        # to arrive
        vol.Optional(c.CONFIG_END_DEVICE_BIND_TIMEOUT.name): vol.All(
            int, vol.Range(min=1)
        ),
        #
