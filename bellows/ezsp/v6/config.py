...
del EZSP_SCHEMA[v5_config.types.EzspConfigId.CONFIG_MOBILE_NODE_POLL_TIMEOUT.name]
del EZSP_SCHEMA[v5_config.types.EzspConfigId.CONFIG_RESERVED_MOBILE_CHILD_ENTRIES.name]
del EZSP_SCHEMA[v5_config.types.EzspConfigId.CONFIG_RF4CE_PAIRING_TABLE_SIZE.name]
del EZSP_SCHEMA[
    v5_config.types.EzspConfigId.CONFIG_RF4CE_PENDING_OUTGOING_PACKET_TABLE_SIZE.name
]
