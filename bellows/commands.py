...
COMMANDS = {
    ...
    'getValue': (0xAA, (t.EzspValueId, ), (t.EzspStatus, t.LVString)),
    'getExtendedValue': (0x03, (t.EzspExtendedValueId, t.uint32_t), (t.EzspStatus, t.LVString)),
    'setValue': (0xAB, (t.EzspValueId, t.LVString), (t.EzspStatus, )),
    ...
    # 5. Utilities Frames
    'nop': (0x05, (), ()),
    'echo': (0x81, (t.LVString, ), (t.LVString, )),
    ...
    'getMfgToken': (0x0B, (t.EzspMfgTokenId, ), (t.LVString, )),
    'setMfgToken': (0x0C, (t.EzspMfgTokenId, t.LVString), (t.EmberStatus, )),
    ...
    'debugWrite': (0x12, (t.Bool, t.LVString), (t.EmberStatus, )),
    'readAndClearCounters': (0x65, (), (t.fixed_list(t.EmberCounterType.EMBER_COUNTER_TYPE_COUNT, t.uint16_t), )),
    'readCounters': (0xF1, (), (t.fixed_list(t.EmberCounterType.EMBER_COUNTER_TYPE_COUNT, t.uint16_t), )),
    ...
    'customFrame': (0x47, (t.LVString, ), (t.EmberStatus, t.LVString)),
    'customFrameHandler': (0x54, (), (t.LVString, )),
    ...
    'sendUnicast': (0x34, (t.EmberOutgoingMessageType, t.EmberNodeId, t.EmberApsFrame, t.uint8_t, t.LVString), (t.EmberStatus, t.uint8_t)),
    'sendBroadcast': (0x36, (t.EmberNodeId, t.EmberApsFrame, t.uint8_t, t.uint8_t, t.uint8_t, t.LVString), (t.EmberStatus, t.uint8_t)),
    'proxyBroadcast': (0x37, (t.EmberNodeId, t.EmberNodeId, t.uint8_t, t.EmberApsFrame, t.uint8_t, t.uint8_t, t.LVString), (t.EmberStatus, t.uint8_t)),
    'sendMulticast': (0x38, (t.EmberApsFrame, t.uint8_t, t.uint8_t, t.uint8_t, t.LVString), (t.EmberStatus, t.uint8_t)),
    'sendReply': (0x39, (t.EmberNodeId, t.EmberApsFrame, t.LVString), (t.EmberStatus, )),
    'messageSentHandler': (0x3F, (), (t.EmberOutgoingMessageType, t.uint16_t, t.EmberApsFrame, t.uint8_t, t.EmberStatus, t.LVString)),
    ...
    'incomingMessageHandler': (0x45, (), (t.EmberIncomingMessageType, t.EmberApsFrame, t.uint8_t, t.int8s, t.EmberNodeId, t.uint8_t, t.uint8_t, t.LVString)),
    # TODO: LVString in incomingRouteRecordHandler is really a list of
    #       uint16_t - decoding this frame will be incorrect, since the length
    #       refers to the number of items in the list
    'incomingRouteRecordHandler': (0x59, (), (t.EmberNodeId, t.EmberEUI64, t.uint8_t, t.int8s, t.LVString)),
    # TODO: LVString in setSourceRoute is really a list of uint16_t,
    ...
    #       list
    # 'setSourceRoute': (0x5A, (t.EmberNodeId, t.LVString), (t.EmberStatus, )),
    ...
    'sendRawMessage': (0x96, (t.LVString, ), (t.EmberStatus, )),
    'macPassthroughMessageHandler': (0x97, (), (t.EmberMacPassthroughType, t.uint8_t, t.int8s, t.LVString)),
    'macFilterMatchMessageHandler': (0x46, (), (t.uint8_t, t.EmberMacPassthroughType, t.uint8_t, t.int8s, t.LVString)),
    ...
    'aesMmoHash': (0x6F, (t.EmberAesMmoHashContext, t.Bool, t.LVString), (t.EmberStatus, t.EmberAesMmoHashContext)),
    ...
    'dsaSign': (0xA6, (t.LVString, ), (t.EmberStatus, )),  # Deprecated
    'dsaSignHandler': (0xA7, (), (t.EmberStatus, t.LVString)),  # Deprecated
    ...
    'mfglibSendPacket': (0x89, (t.LVString, ), (t.EmberStatus, )),
    ...
    'mfglibRxHandler': (0x8E, (), (t.uint8_t, t.int8s, t.LVString)),
    # 13. Bootloader Frames
    'launchStandaloneBootloader': (0x8F, (t.uint8_t, ), (t.EmberStatus, )),
    'sendBootloadMessage': (0x90, (t.Bool, t.EmberEUI64, t.LVString), (t.EmberStatus, )),
    'getStandaloneBootloaderVersionPlatMicroPhy': (0x91, (), (t.uint16_t, t.uint8_t, t.uint8_t, t.uint8_t)),
    'incomingBootloadMessageHandler': (0x92, (), (t.EmberEUI64, t.uint8_t, t.int8s, t.LVString)),
    'bootloadTransmitCompleteHandler': (0x93, (), (t.EmberStatus, t.LVString)),
    ...
    'rf4ceSend': (0xD4, (t.uint8_t, t.uint8_t, t.uint16_t, t.EmberRf4ceTxOption, t.uint8_t, t.LVString), (t.EmberStatus, )),
    'rf4ceIncomingMessageHandler': (0xD5, (), (t.uint8_t, t.uint8_t, t.uint16_t, t.EmberRf4ceTxOption, t.LVString)),
    'rf4ceMessageSentHandler': (0xD6, (), (t.EmberStatus, t.uint8_t, t.EmberRf4ceTxOption, t.uint8_t, t.uint16_t, t.uint8_t, t.LVString)),
    'rf4ceStart': (0xD7, (t.EmberRf4ceNodeCapabilities, t.EmberRf4ceVendorInfo, t.int8s), (t.EmberStatus, )),
    'rf4ceStop': (0xD8, (), (t.EmberStatus, )),
    'rf4ceDiscovery': (0xD9, (t.EmberPanId, t.EmberNodeId, t.uint8_t, t.uint16_t, t.LVString), (t.EmberStatus, )),
    ...
    'dGpSend': (0xC6, (t.Bool, t.Bool, t.EmberGpAddress, t.uint8_t, t.LVString, t.uint8_t, t.uint16_t), (t.EmberStatus, )),
    'dGpSentHandler': (0xC7, (), (t.EmberStatus, t.uint8_t)),
    'gpepIncomingMessageHandler': (0xC5, (), (t.EmberStatus, t.uint8_t, t.uint8_t, t.EmberGpAddress, t.EmberGpSecurityLevel, t.EmberGpKeyType, t.Bool, t.Bool, t.uint32_t, t.uint8_t, t.uint32_t, t.EmberGpSinkListEntry, t.LVString)),
}
